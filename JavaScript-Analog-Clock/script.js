...
var outerCircle = document.getElementById("outer-circle");
       outerCircle.style.backgroundImage = "url('pic.jpg')";
//create  minute scale
for(let i = 0; i<60; i++){
...
function setHands(){
  ...
  if (secondHandAngle>=180 || secondHandAngle<=0) 
    {
       innerCircle.style.backgroundImage = "url('209103.gif')";

    } 
  else 
    {
       innerCircle.style.backgroundImage = "url('9471.gif')";
    }
}
